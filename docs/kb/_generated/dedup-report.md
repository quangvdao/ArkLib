...
- `ArkLib` — 464 files, 7984 declarations

## Same short-name across multiple files (231 groups)
...
- `def CheckClaim.reduction` [ArkLib/ProofSystem/Component/CheckClaim.lean:74](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L74) — The reduction for the `CheckClaim` reduction.
- `def DoNothing.reduction` [ArkLib/ProofSystem/Component/DoNothing.lean:46](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L46) — The reduction for the `DoNothing` reduction. - Prover simply returns the statement and witness. - Ve
- `def NoInteraction.reduction` [ArkLib/ProofSystem/Component/NoInteraction.lean:65](../../../ArkLib/ProofSystem/Component/NoInteraction.lean#L65) — The no-interaction reduction can be specified by a tuple of functions: - `mapStmt : StmtIn → OracleC
- `def ReduceClaim.reduction` [ArkLib/ProofSystem/Component/ReduceClaim.lean:63](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L63) — The reduction for the `ReduceClaim` reduction.
- `def SendWitness.reduction` [ArkLib/ProofSystem/Component/SendWitness.lean:81](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L81) — (no docstring)
...
- `def Sumcheck.Spec.reduction` [ArkLib/ProofSystem/Sumcheck/Spec/General.lean:169](../../../ArkLib/ProofSystem/Sumcheck/Spec/General.lean#L169) — The sum-check protocol as a reduction
- `def Sumcheck.Spec.SingleRound.Simple.reduction` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:405](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L405) — The reduction for the simple description of a single round of sum-check
- `def Sumcheck.Spec.SingleRound.reduction` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:966](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L966) — The sum-check reduction for the `i`-th round of the sum-check protocol
...
- `def CheckClaim.oracleReduction` [ArkLib/ProofSystem/Component/CheckClaim.lean:245](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L245) — The oracle reduction for the `CheckClaim` oracle reduction.
- `def DoNothing.oracleReduction` [ArkLib/ProofSystem/Component/DoNothing.lean:90](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L90) — The oracle reduction for the `DoNothing` oracle reduction. - Prover simply returns the (non-oracle a
- `def RandomQuery.oracleReduction` [ArkLib/ProofSystem/Component/RandomQuery.lean:124](../../../ArkLib/ProofSystem/Component/RandomQuery.lean#L124) — Combine the trivial prover and this verifier to form the `RandomQuery` oracle reduction: the input o
- `def ReduceClaim.oracleReduction` [ArkLib/ProofSystem/Component/ReduceClaim.lean:304](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L304) — The oracle reduction for the `ReduceClaim` oracle reduction.
- `def SendChallenge.oracleReduction` [ArkLib/ProofSystem/Component/SendChallenge.lean:102](../../../ArkLib/ProofSystem/Component/SendChallenge.lean#L102) — The oracle reduction for `SendChallenge`.
- `def SendClaim.oracleReduction` [ArkLib/ProofSystem/Component/SendClaim.lean:121](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L121) — The oracle reduction for `SendClaim`.
- `def SendSingleWitness.oracleReduction` [ArkLib/ProofSystem/Component/SendWitness.lean:391](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L391) — (no docstring)
- `def Sumcheck.Spec.oracleReduction` [ArkLib/ProofSystem/Sumcheck/Spec/General.lean:181](../../../ArkLib/ProofSystem/Sumcheck/Spec/General.lean#L181) — The sum-check protocol as an oracle reduction
- `def Sumcheck.Spec.SingleRound.Simpler.oracleReduction` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:301](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L301) — (no docstring)
...
- `def Sumcheck.Spec.SingleRound.oracleReduction` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:985](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L985) — The sum-check oracle reduction for the `i`-th round of the sum-check protocol
...
- `def ArkLib.Lattices.Ajtai.InnerOuter.verifier` [ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean:428](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean#L428) — The reduction's verifier (Hachi §4.2, Figure 3) is a **pure pass-through**: it re-emits the statemen
...
- `def CheckClaim.verifier` [ArkLib/ProofSystem/Component/CheckClaim.lean:69](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L69) — The verifier for the `CheckClaim` reduction.
- `def DoNothing.verifier` [ArkLib/ProofSystem/Component/DoNothing.lean:37](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L37) — The verifier for the `DoNothing` reduction.
- `def NoInteraction.verifier` [ArkLib/ProofSystem/Component/NoInteraction.lean:56](../../../ArkLib/ProofSystem/Component/NoInteraction.lean#L56) — The verifier in a no-interaction reduction takes an empty transcript, and hence reduce to a function
- `def ReduceClaim.verifier` [ArkLib/ProofSystem/Component/ReduceClaim.lean:59](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L59) — The verifier for the `ReduceClaim` reduction.
- `def SendWitness.verifier` [ArkLib/ProofSystem/Component/SendWitness.lean:77](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L77) — (no docstring)
...
- `def Sumcheck.Spec.verifier` [ArkLib/ProofSystem/Sumcheck/Spec/General.lean:150](../../../ArkLib/ProofSystem/Sumcheck/Spec/General.lean#L150) — The verifier for the (full) sum-check protocol
- `def Sumcheck.Spec.SingleRound.Simple.verifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:386](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L386) — The verifier for the simple description of a single round of sum-check
- `def Sumcheck.Spec.SingleRound.verifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:954](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L954) — The verifier for the `i`-th round of the sum-check protocol
- `def Sumcheck.Spec.SingleRound.Unfolded.verifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1233](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1233) — The (non-oracle) verifier of the sum-check protocol for the `i`-th round, where `i < n + 1`
...
- `def CheckClaim.oracleVerifier` [ArkLib/ProofSystem/Component/CheckClaim.lean:225](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L225) — (no docstring)
- `def DoNothing.oracleVerifier` [ArkLib/ProofSystem/Component/DoNothing.lean:80](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L80) — The oracle verifier for the `DoNothing` oracle reduction.
- `def RandomQuery.oracleVerifier` [ArkLib/ProofSystem/Component/RandomQuery.lean:90](../../../ArkLib/ProofSystem/Component/RandomQuery.lean#L90) — The oracle verifier simply returns the challenge, and performs no checks.
- `def ReduceClaim.oracleVerifier` [ArkLib/ProofSystem/Component/ReduceClaim.lean:294](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L294) — The oracle verifier for the `ReduceClaim` oracle reduction.
- `def SendChallenge.oracleVerifier` [ArkLib/ProofSystem/Component/SendChallenge.lean:82](../../../ArkLib/ProofSystem/Component/SendChallenge.lean#L82) — (no docstring)
- `def SendClaim.oracleVerifier` [ArkLib/ProofSystem/Component/SendClaim.lean:113](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L113) — (no docstring)
- `def SendSingleWitness.oracleVerifier` [ArkLib/ProofSystem/Component/SendWitness.lean:367](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L367) — The oracle verifier for the `SendSingleWitness` oracle reduction. The verifier receives the input st
...
- `def Sumcheck.Spec.oracleVerifier` [ArkLib/ProofSystem/Sumcheck/Spec/General.lean:159](../../../ArkLib/ProofSystem/Sumcheck/Spec/General.lean#L159) — The oracle verifier for the (full) sum-check protocol
- `def Sumcheck.Spec.SingleRound.Simple.oracleVerifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:418](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L418) — (no docstring)
- `def Sumcheck.Spec.SingleRound.oracleVerifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:960](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L960) — The oracle verifier for the `i`-th round of the sum-check protocol
...
- `def ArkLib.Lattices.Ajtai.InnerOuter.prover` [ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean:454](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean#L454) — The honest prover (Hachi §4.2, Figure 3; completeness is out of scope for Lemma 8): round 0 sends th
...
- `def Sumcheck.Spec.SingleRound.Simple.prover` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:360](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L360) — The prover in the simple description of a single round of sum-check. Takes in input `target : R` and
- `def Sumcheck.Spec.SingleRound.Unfolded.prover` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1223](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1223) — The overall prover for the `i`-th round of the sum-check protocol, where `i < n`. This is only well-
...
- `def Sumcheck.Spec.pSpec` [ArkLib/ProofSystem/Sumcheck/Spec/General.lean:126](../../../ArkLib/ProofSystem/Sumcheck/Spec/General.lean#L126) — The protocol specification for the general sum-check protocol, which is the composition of the singl
...
- `def CheckClaim.oracleProver` [ArkLib/ProofSystem/Component/CheckClaim.lean:195](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L195) — The oracle prover for the `CheckClaim` oracle reduction: it forwards the statement and all oracle st
- `def DoNothing.oracleProver` [ArkLib/ProofSystem/Component/DoNothing.lean:70](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L70) — The oracle prover for the `DoNothing` oracle reduction.
...
- `def ReduceClaim.oracleProver` [ArkLib/ProofSystem/Component/ReduceClaim.lean:279](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L279) — The oracle prover for the `ReduceClaim` oracle reduction.
...
- `def SendWitness.oracleProver` [ArkLib/ProofSystem/Component/SendWitness.lean:221](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L221) — The oracle prover for the `SendWitness` oracle reduction. For each round `i : Fin (FinEnum.card ιw)`
- `def SendSingleWitness.oracleProver` [ArkLib/ProofSystem/Component/SendWitness.lean:324](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L324) — The oracle prover for the `SendSingleWitness` oracle reduction. The prover sends the witness `wit` t
...
- `theorem DoNothing.oracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Component/DoNothing.lean:106](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L106) — The `DoNothing` oracle verifier is perfectly round-by-round knowledge sound.
- `theorem RandomQuery.oracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Component/RandomQuery.lean:290](../../../ArkLib/ProofSystem/Component/RandomQuery.lean#L290) — The `RandomQuery` oracle reduction is round-by-round knowledge sound. The key fact governing the sou
- `theorem ReduceClaim.oracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Component/ReduceClaim.lean:438](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L438) — The `ReduceClaim` oracle reduction satisfies perfect round-by-round knowledge soundness. Note that s
- `theorem Sumcheck.Spec.oracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Sumcheck/Spec/General.lean:220](../../../ArkLib/ProofSystem/Sumcheck/Spec/General.lean#L220) — Round-by-round knowledge soundness with error `deg / \|R\|` per challenge for the (full) sum-check pro
- `theorem Sumcheck.Spec.SingleRound.Simpler.oracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:316](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L316) — (no docstring)
- `theorem Sumcheck.Spec.SingleRound.Simple.oracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:730](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L730) — Round-by-round knowledge soundness for the oracle verifier
- `theorem Sumcheck.Spec.SingleRound.oracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1117](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1117) — Round-by-round knowledge soundness theorem for single-round of sum-check, obtained by transporting t
...
- `instance CheckClaim.instOutputIsPure` [ArkLib/ProofSystem/Component/CheckClaim.lean:63](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L63) — The `CheckClaim` prover has pure output: it reads its statement off the state, with no oracle query.
- `instance DoNothing.instOutputIsPure` [ArkLib/ProofSystem/Component/DoNothing.lean:33](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L33) — The `DoNothing` prover has pure output: it is `Prover.id`, whose `output` is `pure`.
- `instance RandomQuery.instOutputIsPure` [ArkLib/ProofSystem/Component/RandomQuery.lean:84](../../../ArkLib/ProofSystem/Component/RandomQuery.lean#L84) — The `RandomQuery` oracle prover has pure output: it repackages the received challenge and the oracle
- `instance ReduceClaim.instOutputIsPure` [ArkLib/ProofSystem/Component/ReduceClaim.lean:56](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L56) — The `ReduceClaim` prover has pure output: it applies the two plain maps `mapStmt` / `mapWit`, with n
- `instance SendChallenge.instOutputIsPure` [ArkLib/ProofSystem/Component/SendChallenge.lean:67](../../../ArkLib/ProofSystem/Component/SendChallenge.lean#L67) — The `SendChallenge` oracle prover has pure output: it appends the received challenge to the statemen
- `instance SendClaim.instOutputIsPure` [ArkLib/ProofSystem/Component/SendClaim.lean:86](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L86) — The `SendClaim` oracle prover has pure output: it exposes the claim it already computed alongside th
- `instance SendWitness.instOutputIsPure` [ArkLib/ProofSystem/Component/SendWitness.lean:74](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L74) — The `SendWitness` prover has pure output: it pairs up the state it already holds, with no oracle que
- `instance SendSingleWitness.instOutputIsPure` [ArkLib/ProofSystem/Component/SendWitness.lean:336](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L336) — The `SendSingleWitness` oracle prover has pure output: it exposes the witness message alongside the
...
- `def Sumcheck.Spec.SingleRound.Simpler.inputRelation` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:243](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L243) — (no docstring)
- `def Sumcheck.Spec.SingleRound.Simple.inputRelation` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:345](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L345) — (no docstring)
...
- `def ProtocolSpec.FullTranscript.append` [ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean:168](../../../ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean#L168) — Appending two transcripts for two `ProtocolSpec`s
...
- `instance CheckClaim.instIsPure` [ArkLib/ProofSystem/Component/CheckClaim.lean:268](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L268) — The `CheckClaim` oracle verifier is pure: its underlying verifier deterministically returns the comb
- `instance ReduceClaim.instIsPure` [ArkLib/ProofSystem/Component/ReduceClaim.lean:222](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L222) — The `ReduceClaim` verifier is pure: it deterministically returns `mapStmt stmt`. This discharges the
- `instance SendChallenge.instIsPure` [ArkLib/ProofSystem/Component/SendChallenge.lean:126](../../../ArkLib/ProofSystem/Component/SendChallenge.lean#L126) — The `SendChallenge` oracle verifier is pure: it deterministically appends the (transcript-read) chal
- `instance SendClaim.instIsPure` [ArkLib/ProofSystem/Component/SendClaim.lean:162](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L162) — The `SendClaim` oracle verifier is pure, discharging the deterministic-left hypothesis of the CWSS b
- `instance SendWitness.instIsPure` [ArkLib/ProofSystem/Component/SendWitness.lean:96](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L96) — The `SendWitness` verifier is pure: it deterministically returns `⟨stmt, transcript 0⟩`. This discha
- `instance SendSingleWitness.instIsPure` [ArkLib/ProofSystem/Component/SendWitness.lean:420](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L420) — The `SendSingleWitness` oracle verifier is pure: its underlying (non-oracle) verifier deterministica
...
- `theorem DoNothing.reduction_perfectCompleteness` [ArkLib/ProofSystem/Component/DoNothing.lean:54](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L54) — The `DoNothing` reduction satisfies perfect completeness for any relation.
...
- `theorem Sumcheck.Spec.SingleRound.Simple.reduction_perfectCompleteness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:529](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L529) — Perfect completeness for the (non-oracle) reduction
- `theorem Sumcheck.Spec.SingleRound.reduction_perfectCompleteness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1078](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1078) — (no docstring)

### `oracleVerifier_materializeOutput` (5 declarations, 5 files)

- `theorem CheckClaim.oracleVerifier_materializeOutput` [ArkLib/ProofSystem/Component/CheckClaim.lean:231](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L231) — (no docstring)
- `theorem RandomQuery.oracleVerifier_materializeOutput` [ArkLib/ProofSystem/Component/RandomQuery.lean:108](../../../ArkLib/ProofSystem/Component/RandomQuery.lean#L108) — (no docstring)
- `theorem SendChallenge.oracleVerifier_materializeOutput` [ArkLib/ProofSystem/Component/SendChallenge.lean:88](../../../ArkLib/ProofSystem/Component/SendChallenge.lean#L88) — (no docstring)
- `theorem SendClaim.oracleVerifier_materializeOutput` [ArkLib/ProofSystem/Component/SendClaim.lean:131](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L131) — (no docstring)
- `theorem SendSingleWitness.oracleVerifier_materializeOutput` [ArkLib/ProofSystem/Component/SendWitness.lean:374](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L374) — (no docstring)

### `oracleVerifier_toVerifier_run` (5 declarations, 5 files)

- `theorem CheckClaim.oracleVerifier_toVerifier_run` [ArkLib/ProofSystem/Component/CheckClaim.lean:254](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L254) — The pure pass-through oracle verifier's underlying non-oracle verifier returns the combined input st
- `theorem ReduceClaim.oracleVerifier_toVerifier_run` [ArkLib/ProofSystem/Component/ReduceClaim.lean:449](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L449) — The `ReduceClaim` oracle verifier's underlying non-oracle verifier deterministically returns the map
- `theorem SendChallenge.oracleVerifier_toVerifier_run` [ArkLib/ProofSystem/Component/SendChallenge.lean:115](../../../ArkLib/ProofSystem/Component/SendChallenge.lean#L115) — The pure verifier's underlying non-oracle verifier returns the statement together with the sampled c
- `theorem SendClaim.oracleVerifier_toVerifier_run` [ArkLib/ProofSystem/Component/SendClaim.lean:149](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L149) — The pure pass-through oracle verifier's underlying non-oracle verifier returns the statement togethe
- `theorem SendSingleWitness.oracleVerifier_toVerifier_run` [ArkLib/ProofSystem/Component/SendWitness.lean:409](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L409) — (no docstring)
...
- `def Sumcheck.Spec.SingleRound.Simpler.outputRelation` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:272](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L272) — (no docstring)
- `def Sumcheck.Spec.SingleRound.Simple.outputRelation` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:348](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L348) — (no docstring)

### `commit` (4 declarations, 4 files)

- `def ArkLib.Lattices.Ajtai.InnerOuter.commit` [ArkLib/Commitments/Functional/Hachi/Commitment.lean:111](../../../ArkLib/Commitments/Functional/Hachi/Commitment.lean#L111) — **The honest Hachi commitment**, at the paper's balanced base-`b` digits. Reshape `p` into its `2^r
...
- `instance CheckClaim.instOutputIsPureOracle` [ArkLib/ProofSystem/Component/CheckClaim.lean:205](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L205) — The `CheckClaim` oracle prover has pure output: it forwards the statement and oracle statements with
- `instance DoNothing.instOutputIsPureOracle` [ArkLib/ProofSystem/Component/DoNothing.lean:75](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L75) — The `DoNothing` oracle prover has pure output: it is `OracleProver.id`, which unfolds to `Prover.id`
- `instance ReduceClaim.instOutputIsPureOracle` [ArkLib/ProofSystem/Component/ReduceClaim.lean:290](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L290) — The `ReduceClaim` oracle prover has pure output: it applies the plain maps `mapStmt`, `mapOStmt`, an
- `instance SendWitness.instOutputIsPureOracle` [ArkLib/ProofSystem/Component/SendWitness.lean:234](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L234) — The `SendWitness` oracle prover has pure output: it exposes the witness alongside the input oracles,

### `oracleReduction_completeness` (4 declarations, 4 files)

- `theorem CheckClaim.oracleReduction_completeness` [ArkLib/ProofSystem/Component/CheckClaim.lean:290](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L290) — **Perfect completeness of the pure pass-through `CheckClaim` oracle reduction.** Because the verifie
- `theorem RandomQuery.oracleReduction_completeness` [ArkLib/ProofSystem/Component/RandomQuery.lean:137](../../../ArkLib/ProofSystem/Component/RandomQuery.lean#L137) — The `RandomQuery` oracle reduction is perfectly complete.
- `theorem ReduceClaim.oracleReduction_completeness` [ArkLib/ProofSystem/Component/ReduceClaim.lean:320](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L320) — The `ReduceClaim` oracle reduction satisfies perfect completeness for any relation. Proof strategy m
- `theorem SendSingleWitness.oracleReduction_completeness` [ArkLib/ProofSystem/Component/SendWitness.lean:436](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L436) — The `SendSingleWitness` oracle reduction satisfies perfect completeness.

### `oracleVerifier_coordinateWiseSpecialSoundWith` (4 declarations, 4 files)

- `theorem CheckClaim.oracleVerifier_coordinateWiseSpecialSoundWith` [ArkLib/ProofSystem/Component/CheckClaim.lean:348](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L348) — **Coordinate-wise special soundness of `CheckClaim`, named form.** The verifier is a pure pass-throu
- `theorem ReduceClaim.oracleVerifier_coordinateWiseSpecialSoundWith` [ArkLib/ProofSystem/Component/ReduceClaim.lean:479](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L479) — **Coordinate-wise special soundness of the `ReduceClaim` oracle reduction, named form.** As in the n
- `theorem SendClaim.oracleVerifier_coordinateWiseSpecialSoundWith` [ArkLib/ProofSystem/Component/SendClaim.lean:188](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L188) — **Coordinate-wise special soundness of `SendClaim`, named form.** The verifier is a pure pass-throug
- `theorem SendSingleWitness.oracleVerifier_coordinateWiseSpecialSoundWith` [ArkLib/ProofSystem/Component/SendWitness.lean:463](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L463) — **Coordinate-wise special soundness of `SendSingleWitness`, named form.** The oracle verifier has no

### `outputEmbedding` (4 declarations, 4 files)

- `def CheckClaim.outputEmbedding` [ArkLib/ProofSystem/Component/CheckClaim.lean:214](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L214) — The oracle verifier for the `CheckClaim` oracle reduction is a **pure pass-through**: it returns the
- `def SendChallenge.outputEmbedding` [ArkLib/ProofSystem/Component/SendChallenge.lean:72](../../../ArkLib/ProofSystem/Component/SendChallenge.lean#L72) — The oracle verifier samples the challenge `c` (as the `V_to_P` round), reads it off the transcript,
- `def SendClaim.outputEmbedding` [ArkLib/ProofSystem/Component/SendClaim.lean:96](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L96) — (no docstring)
- `def SendSingleWitness.outputEmbedding` [ArkLib/ProofSystem/Component/SendWitness.lean:345](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L345) — (no docstring)

### `reduction_completeness` (4 declarations, 4 files)

- `theorem CheckClaim.reduction_completeness` [ArkLib/ProofSystem/Component/CheckClaim.lean:89](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L89) — The `CheckClaim` reduction satisfies perfect completeness with respect to the predicate as the input
- `theorem NoInteraction.reduction_completeness` [ArkLib/ProofSystem/Component/NoInteraction.lean:72](../../../ArkLib/ProofSystem/Component/NoInteraction.lean#L72) — (no docstring)
- `theorem ReduceClaim.reduction_completeness` [ArkLib/ProofSystem/Component/ReduceClaim.lean:149](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L149) — The `ReduceClaim` reduction satisfies perfect completeness for any relation. The `↔` form of `reduct
- `theorem SendWitness.reduction_completeness` [ArkLib/ProofSystem/Component/SendWitness.lean:102](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L102) — The `SendWitness` reduction satisfies perfect completeness.
...
- `def CheckClaim.relOut` [ArkLib/ProofSystem/Component/CheckClaim.lean:82](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L82) — (no docstring)
...
- `def ReduceClaim.treeExtractor` [ArkLib/ProofSystem/Component/ReduceClaim.lean:233](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L233) — **The `ReduceClaim` tree extractor**, witness-only: the zero-round tree has a single root-to-leaf pa
...
- `theorem DoNothing.oracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Component/DoNothing.lean:100](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L100) — The `DoNothing` oracle reduction satisfies perfect completeness for any relation.
- `theorem Sumcheck.Spec.SingleRound.Simple.oracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:716](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L716) — Perfect completeness for the oracle reduction
- `theorem Sumcheck.Spec.SingleRound.oracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1096](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1096) — Completeness theorem for single-round of sum-check, obtained by transporting the completeness proof
...
- `def Sumcheck.Spec.StmtIn` [ArkLib/ProofSystem/Sumcheck/Spec/General.lean:138](../../../ArkLib/ProofSystem/Sumcheck/Spec/General.lean#L138) — The input statement for the (full) sum-check protocol, which contains only the target sum value
- `def Sumcheck.Spec.SingleRound.Simpler.StmtIn` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:240](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L240) — (no docstring)
- `def Sumcheck.Spec.SingleRound.Simple.StmtIn` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:334](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L334) — (no docstring)
...
- `theorem DoNothing.verifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Component/DoNothing.lean:60](../../../ArkLib/ProofSystem/Component/DoNothing.lean#L60) — The `DoNothing` verifier is perfectly round-by-round knowledge sound.
- `theorem ReduceClaim.verifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Component/ReduceClaim.lean:213](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L213) — The `ReduceClaim` oracle reduction satisfies perfect round-by-round knowledge soundness. Note that s
- `theorem Sumcheck.Spec.SingleRound.Simple.verifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:724](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L724) — Round-by-round knowledge soundness for the verifier
- `theorem Sumcheck.Spec.SingleRound.verifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:1086](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L1086) — (no docstring)
...
- `structure Interaction.Oracle.Reduction` [ArkLib/Interaction/Oracle/Execution.lean:253](../../../ArkLib/Interaction/Oracle/Execution.lean#L253) — A small statement/witness wrapper around oracle strategies. The verifier is built from the public st
...
- `def coreInteractionOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:786](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L786) — The final oracle reduction that composes sumcheckFold with finalSumcheckStep
- `def Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:777](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L777) — The final oracle reduction that composes sumcheckFold with finalSumcheckStep
- `def RingSwitching.SumcheckPhase.coreInteractionOracleReduction` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:541](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L541) — Large-field reduction: Sumcheck seqCompose, then append FinalSum

### `coreInteractionOracleVerifier` (3 declarations, 3 files)

- `def coreInteractionOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:770](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L770) — The final oracle verifier that composes sumcheckFold with finalSumcheckStep
- `def Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleVerifier` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:757](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L757) — The final oracle verifier that composes sumcheckFold with finalSumcheckStep
- `def RingSwitching.SumcheckPhase.coreInteractionOracleVerifier` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:532](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L532) — Large-field reduction verifier: Sumcheck seqCompose, then append FinalSum
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKStateProp` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:673](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L673) — (no docstring)
- `def RingSwitching.SumcheckPhase.finalSumcheckKStateProp` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:433](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L433) — (no docstring)
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:714](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L714) — The knowledge state function for the final sumcheck step
- `def RingSwitching.SumcheckPhase.finalSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:461](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L461) — The knowledge state function for the final sumcheck step
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:593](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L593) — The oracle reduction for the final sumcheck step
- `def RingSwitching.SumcheckPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:379](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L379) — The oracle reduction for the final sumcheck step
...
- `theorem Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:610](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L610) — Perfect completeness for the final sumcheck step
- `theorem RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:394](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L394) — Perfect completeness for the final sumcheck step
...
- `theorem Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:736](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L736) — Round-by-round knowledge soundness for the final sumcheck step
- `theorem RingSwitching.SumcheckPhase.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:484](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L484) — Round-by-round knowledge soundness for the final sumcheck step
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckProver` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:491](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L491) — The prover for the final sumcheck step
- `def RingSwitching.SumcheckPhase.finalSumcheckProver` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:316](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L316) — The prover for the final sumcheck step
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:639](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L639) — The round-by-round extractor for the final sumcheck step
- `def RingSwitching.SumcheckPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:412](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L412) — The round-by-round extractor for the final sumcheck step
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckVerifier` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:539](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L539) — The verifier for the final sumcheck step
- `def RingSwitching.SumcheckPhase.finalSumcheckVerifier` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:360](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L360) — The verifier for the final sumcheck step, as an instance of the family-shared check-then-update one-

### `fullOracleProof` (3 declarations, 3 files)

- `def Binius.BinaryBasefold.FullBinaryBasefold.fullOracleProof` [ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean:92](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean#L92) — The full Binary Basefold protocol as a Proof
- `def Binius.FRIBinius.FullFRIBinius.fullOracleProof` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:170](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L170) — The full Binary Basefold protocol as a Proof
- `def RingSwitching.FullRingSwitching.fullOracleProof` [ArkLib/ProofSystem/RingSwitching/Packing/General.lean:99](../../../ArkLib/ProofSystem/RingSwitching/Packing/General.lean#L99) — The full DP24 ring-switching protocol as a Proof

### `fullOracleReduction` (3 declarations, 3 files)

- `def Binius.BinaryBasefold.FullBinaryBasefold.fullOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean:66](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean#L66) — The reduction for the full Binary Basefold protocol
...
- `def RingSwitching.FullRingSwitching.fullOracleReduction` [ArkLib/ProofSystem/RingSwitching/Packing/General.lean:86](../../../ArkLib/ProofSystem/RingSwitching/Packing/General.lean#L86) — The reduction for the full DP24 ring-switching protocol

### `fullOracleReduction_perfectCompleteness` (3 declarations, 3 files)

- `theorem Binius.BinaryBasefold.FullBinaryBasefold.fullOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean:107](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean#L107) — Perfect completeness for the full Binary Basefold protocol (reduction)
- `theorem Binius.FRIBinius.FullFRIBinius.fullOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:185](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L185) — The full FRI-Binius oracle proof is perfectly complete.
- `theorem RingSwitching.FullRingSwitching.fullOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/Packing/General.lean:150](../../../ArkLib/ProofSystem/RingSwitching/Packing/General.lean#L150) — (no docstring)
...
- `def Binius.FRIBinius.FullFRIBinius.fullOracleVerifier` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:119](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L119) — The oracle verifier for the full Binary Basefold protocol
- `def RingSwitching.FullRingSwitching.fullOracleVerifier` [ArkLib/ProofSystem/RingSwitching/Packing/General.lean:68](../../../ArkLib/ProofSystem/RingSwitching/Packing/General.lean#L68) — The oracle verifier for the full DP24 ring-switching protocol

### `knowledgeStateFunction` (3 declarations, 3 files)

- `def CheckClaim.knowledgeStateFunction` [ArkLib/ProofSystem/Component/CheckClaim.lean:142](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L142) — The knowledge state function for the `CheckClaim` reduction, mirroring the trivial-verifier template
- `def RandomQuery.knowledgeStateFunction` [ArkLib/ProofSystem/Component/RandomQuery.lean:244](../../../ArkLib/ProofSystem/Component/RandomQuery.lean#L244) — The knowledge state function for the `RandomQuery` oracle reduction.
- `def ReduceClaim.knowledgeStateFunction` [ArkLib/ProofSystem/Component/ReduceClaim.lean:179](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L179) — The knowledge state function for the `ReduceClaim` reduction.

### `rbrExtractor` (3 declarations, 3 files)

- `def RandomQuery.rbrExtractor` [ArkLib/ProofSystem/Component/RandomQuery.lean:237](../../../ArkLib/ProofSystem/Component/RandomQuery.lean#L237) — The round-by-round extractor is trivial since the output witness is `Unit`.
...
- `def CheckClaim.relIn` [ArkLib/ProofSystem/Component/CheckClaim.lean:79](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L79) — (no docstring)
...
- `def Prover.seqCompose` [ArkLib/OracleReduction/Composition/Sequential/General.lean:39](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L39) — Sequential composition of provers, defined via iteration of the composition (append) of two provers.
- `def Verifier.seqCompose` [ArkLib/OracleReduction/Composition/Sequential/General.lean:77](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L77) — Sequential composition of verifiers, defined via iteration of the composition (append) of two verifi
- `def Reduction.seqCompose` [ArkLib/OracleReduction/Composition/Sequential/General.lean:106](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L106) — Sequential composition of reductions, defined via sequential composition of provers and verifiers (o
- `def OracleProver.seqCompose` [ArkLib/OracleReduction/Composition/Sequential/General.lean:137](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L137) — Sequential composition of provers in oracle reductions, defined via sequential composition of prover
- `def OracleVerifier.seqCompose` [ArkLib/OracleReduction/Composition/Sequential/General.lean:184](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L184) — Sequential composition of oracle verifiers (in oracle reductions), defined via iteration of the comp
- `def OracleReduction.seqCompose` [ArkLib/OracleReduction/Composition/Sequential/General.lean:252](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L252) — Sequential composition of oracle reductions, defined via sequential composition of oracle provers an
- `def ProtocolSpec.seqCompose` [ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean:356](../../../ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean#L356) — Sequential composition of a family of `ProtocolSpec`s, indexed by `i : Fin m`. Defined for definitio
- `def ProtocolSpec.FullTranscript.seqCompose` [ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean:414](../../../ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean#L414) — Sequential composition of a family of `FullTranscript`s, indexed by `i : Fin m`. Defined for definit

### `seqCompose_zero` (7 declarations, 2 files)

- `lemma Prover.seqCompose_zero` [ArkLib/OracleReduction/Composition/Sequential/General.lean:50](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L50) — (no docstring)
- `lemma Verifier.seqCompose_zero` [ArkLib/OracleReduction/Composition/Sequential/General.lean:85](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L85) — (no docstring)
- `lemma Reduction.seqCompose_zero` [ArkLib/OracleReduction/Composition/Sequential/General.lean:115](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L115) — (no docstring)
- `lemma OracleVerifier.seqCompose_zero` [ArkLib/OracleReduction/Composition/Sequential/General.lean:198](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L198) — (no docstring)
- `lemma OracleReduction.seqCompose_zero` [ArkLib/OracleReduction/Composition/Sequential/General.lean:268](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L268) — (no docstring)
- `theorem ProtocolSpec.seqCompose_zero` [ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean:372](../../../ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean#L372) — (no docstring)
- `theorem ProtocolSpec.FullTranscript.seqCompose_zero` [ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean:419](../../../ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean#L419) — (no docstring)
...
- `def ProtocolSpec.FullTranscript.concat` [ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean:176](../../../ArkLib/OracleReduction/ProtocolSpec/SeqCompose.lean#L176) — Adding a message with a given direction and type to the end of a `Transcript`
...
- `def Sumcheck.Spec.SingleRound.Simpler.OStmtIn` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:241](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L241) — (no docstring)
- `def Sumcheck.Spec.SingleRound.Simple.OStmtIn` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:340](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L340) — (no docstring)
...
- `def Sumcheck.Spec.SingleRound.Simpler.OStmtOut` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:270](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L270) — (no docstring)
- `def Sumcheck.Spec.SingleRound.Simple.OStmtOut` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:343](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L343) — (no docstring)
...
- `def Sumcheck.Spec.SingleRound.Simpler.StmtOut` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:269](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L269) — (no docstring)
- `def Sumcheck.Spec.SingleRound.Simple.StmtOut` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:337](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L337) — (no docstring)
...
- `def Interaction.Oracle.Access.extend` [ArkLib/Interaction/Oracle/Access.lean:38](../../../ArkLib/Interaction/Oracle/Access.lean#L38) — Add a disjoint query slot for a newly sent oracle message. This is signature extension, not a claim
- `def ProtocolSpec.MessagesUpTo.extend` [ArkLib/OracleReduction/ProtocolSpec/Basic.lean:414](../../../ArkLib/OracleReduction/ProtocolSpec/Basic.lean#L414) — Extend the tuple of messages up to round `k` to up to round `k + 1`, assuming round `k` is a challen
- `def ProtocolSpec.ChallengesUpTo.extend` [ArkLib/OracleReduction/ProtocolSpec/Basic.lean:473](../../../ArkLib/OracleReduction/ProtocolSpec/Basic.lean#L473) — Extend the tuple of challenges up to round `k` to up to round `k + 1`, assuming round `k` is a messa
...
- `instance SendSingleWitness.instIsEmptyChallengeIdx` [ArkLib/ProofSystem/Component/SendWitness.lean:316](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L316) — The `SendSingleWitness` protocol is a single `P_to_V` message, so it has no challenge rounds. This i
...
- `abbrev Interaction.Oracle.TypeTree.AccessDecoration.restrict` [ArkLib/Interaction/Oracle/Access.lean:230](../../../ArkLib/Interaction/Oracle/Access.lean#L230) — Restrict a presentation using PolyFun's canonical displayed restriction.
- `abbrev Interaction.Oracle.TypeTree.RoleDecoration.restrict` [ArkLib/Interaction/Oracle/TypeTree/Decoration.lean:77](../../../ArkLib/Interaction/Oracle/TypeTree/Decoration.lean#L77) — Restrict roles to the residual tree selected by a structural cursor.
- `abbrev Interaction.Oracle.TypeTree.OracleDecoration.restrict` [ArkLib/Interaction/Oracle/TypeTree/Decoration.lean:168](../../../ArkLib/Interaction/Oracle/TypeTree/Decoration.lean#L168) — Restrict oracle interfaces to the residual tree selected by a structural cursor.

### `restrict_comp` (3 declarations, 2 files)

- `theorem Interaction.Oracle.TypeTree.AccessDecoration.restrict_comp` [ArkLib/Interaction/Oracle/Access.lean:248](../../../ArkLib/Interaction/Oracle/Access.lean#L248) — Restriction composes without introducing another cursor representation.
- `theorem Interaction.Oracle.TypeTree.RoleDecoration.restrict_comp` [ArkLib/Interaction/Oracle/TypeTree/Decoration.lean:95](../../../ArkLib/Interaction/Oracle/TypeTree/Decoration.lean#L95) — (no docstring)
- `theorem Interaction.Oracle.TypeTree.OracleDecoration.restrict_comp` [ArkLib/Interaction/Oracle/TypeTree/Decoration.lean:186](../../../ArkLib/Interaction/Oracle/TypeTree/Decoration.lean#L186) — (no docstring)

### `restrict_down` (3 declarations, 2 files)

- `theorem Interaction.Oracle.TypeTree.AccessDecoration.restrict_down` [ArkLib/Interaction/Oracle/Access.lean:240](../../../ArkLib/Interaction/Oracle/Access.lean#L240) — (no docstring)
- `theorem Interaction.Oracle.TypeTree.RoleDecoration.restrict_down` [ArkLib/Interaction/Oracle/TypeTree/Decoration.lean:87](../../../ArkLib/Interaction/Oracle/TypeTree/Decoration.lean#L87) — (no docstring)
- `theorem Interaction.Oracle.TypeTree.OracleDecoration.restrict_down` [ArkLib/Interaction/Oracle/TypeTree/Decoration.lean:178](../../../ArkLib/Interaction/Oracle/TypeTree/Decoration.lean#L178) — (no docstring)

### `restrict_root` (3 declarations, 2 files)

- `theorem Interaction.Oracle.TypeTree.AccessDecoration.restrict_root` [ArkLib/Interaction/Oracle/Access.lean:235](../../../ArkLib/Interaction/Oracle/Access.lean#L235) — (no docstring)
- `theorem Interaction.Oracle.TypeTree.RoleDecoration.restrict_root` [ArkLib/Interaction/Oracle/TypeTree/Decoration.lean:82](../../../ArkLib/Interaction/Oracle/TypeTree/Decoration.lean#L82) — (no docstring)
- `theorem Interaction.Oracle.TypeTree.OracleDecoration.restrict_root` [ArkLib/Interaction/Oracle/TypeTree/Decoration.lean:173](../../../ArkLib/Interaction/Oracle/TypeTree/Decoration.lean#L173) — (no docstring)
...
- `def Binius.FRIBinius.CoreInteractionPhase.FinalSumcheckWit` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:633](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L633) — (no docstring)

### `LiftedWitness` (2 declarations, 2 files)

- `abbrev ArkLib.Lattices.Ajtai.InnerOuter.LiftedWitness` [ArkLib/Commitments/Functional/Hachi/RingSwitch/Reduction.lean:136](../../../ArkLib/Commitments/Functional/Hachi/RingSwitch/Reduction.lean#L136) — Hachi Eq. (21)'s lifted witness: the `R^lin` witness `z ∈ Rq^μ` and one quotient polynomial per row
...
- `def Interaction.Oracle.Reduction.execute` [ArkLib/Interaction/Oracle/Execution.lean:267](../../../ArkLib/Interaction/Oracle/Execution.lean#L267) — Execute the package with arbitrary pure input behavior. This is single-run semantics, not run-derive
- `def Interaction.Reduction.execute` [ArkLib/Interaction/Reduction.lean:142](../../../ArkLib/Interaction/Reduction.lean#L142) — Execute a reduction with PolyFun's canonical two-party runner.
...
- `theorem Reduction.append_completeness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean:158](../../../ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean#L158) — Sequential composition preserves completeness for guarded verifiers when the prover execution factor
- `theorem OracleReduction.append_completeness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/OracleCompleteness.lean:36](../../../ArkLib/OracleReduction/Composition/Sequential/OracleCompleteness.lean#L36) — Oracle reductions with guarded ordinary verifiers compose with the sum of their errors when prover e
...
- `theorem Reduction.append_perfectCompleteness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean:174](../../../ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean#L174) — Guarded verifiers compose perfectly when prover execution factors at the seam and the suffix is perf
- `theorem OracleReduction.append_perfectCompleteness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/OracleCompleteness.lean:53](../../../ArkLib/OracleReduction/Composition/Sequential/OracleCompleteness.lean#L53) — Oracle reductions with guarded ordinary verifiers compose perfectly when prover execution factors at
...
- `def Binius.FRIBinius.FullFRIBinius.batchingCoreReduction` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:102](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L102) — (no docstring)
- `def RingSwitching.FullRingSwitching.batchingCoreReduction` [ArkLib/ProofSystem/RingSwitching/Packing/General.lean:76](../../../ArkLib/ProofSystem/RingSwitching/Packing/General.lean#L76) — (no docstring)

### `batchingCoreVerifier` (2 declarations, 2 files)

- `def Binius.FRIBinius.FullFRIBinius.batchingCoreVerifier` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:88](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L88) — (no docstring)
- `def RingSwitching.FullRingSwitching.batchingCoreVerifier` [ArkLib/ProofSystem/RingSwitching/Packing/General.lean:59](../../../ArkLib/ProofSystem/RingSwitching/Packing/General.lean#L59) — (no docstring)
...
- `def Binius.FRIBinius.CoreInteractionPhase.biniusProfile` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:58](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L58) — The Binius ring-switching profile, built from the boolean-hypercube basis derived from `β`. Kept def
- `def Binius.FRIBinius.FullFRIBinius.biniusProfile` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:53](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L53) — The Binius ring-switching profile, built from the boolean-hypercube basis derived from `β`. Kept def
...
- `def coreInteractionOracleRbrKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:827](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L827) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleRbrKnowledgeError` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:829](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L829) — (no docstring)

### `coreInteractionOracleReduction_perfectCompleteness` (2 declarations, 2 files)

- `theorem coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:806](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L806) — Perfect completeness for the core interaction oracle reduction
- `theorem Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:801](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L801) — Perfect completeness for the core interaction oracle reduction

### `coreInteractionOracleVerifier_rbrKnowledgeSoundness` (2 declarations, 2 files)

- `theorem coreInteractionOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:836](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L836) — Round-by-round knowledge soundness for the core interaction oracle verifier
- `theorem Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:840](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L840) — Round-by-round knowledge soundness for the core interaction oracle verifier
...
- `def Interaction.Oracle.SourceCtx.empty` [ArkLib/Interaction/Oracle/Source.lean:53](../../../ArkLib/Interaction/Oracle/Source.lean#L53) — A source with no queries and no backing data.
...
- `def Interaction.Oracle.SourceCtx.eval` [ArkLib/Interaction/Oracle/Source.lean:119](../../../ArkLib/Interaction/Oracle/Source.lean#L119) — Interpret a program using precisely the answers of the supplied environment.
- `def Plonk.Gate.eval` [ArkLib/ProofSystem/ConstraintSystem/Plonk.lean:53](../../../ArkLib/ProofSystem/ConstraintSystem/Plonk.lean#L53) — Evaluate a gate on a given input vector.
...
- `def Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKnowledgeError` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:628](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L628) — RBR knowledge error for the final sumcheck step
...
- `theorem Binius.BinaryBasefold.FullBinaryBasefold.fullOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean:147](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean#L147) — Round-by-round knowledge soundness for the full Binary Basefold oracle verifier
- `theorem RingSwitching.FullRingSwitching.fullOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/Packing/General.lean:182](../../../ArkLib/ProofSystem/RingSwitching/Packing/General.lean#L182) — Round-by-round knowledge soundness for the full ring-switching oracle verifier

### `fullPspec` (2 declarations, 2 files)

- `def Binius.FRIBinius.FullFRIBinius.fullPspec` [ArkLib/ProofSystem/Binius/FRIBinius/General.lean:61](../../../ArkLib/ProofSystem/Binius/FRIBinius/General.lean#L61) — (no docstring)
...
- `def Binius.BinaryBasefold.FullBinaryBasefold.fullRbrKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean:137](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/General.lean#L137) — Combined RBR knowledge soundness error for the full protocol
- `def RingSwitching.FullRingSwitching.fullRbrKnowledgeError` [ArkLib/ProofSystem/RingSwitching/Packing/General.lean:175](../../../ArkLib/ProofSystem/RingSwitching/Packing/General.lean#L175) — (no docstring)
...
- `instance SendSingleWitness.instOutputOracleInterface` [ArkLib/ProofSystem/Component/SendWitness.lean:306](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L306) — (no docstring)
...
- `def SendClaim.outputIndexEmbedding` [ArkLib/ProofSystem/Component/SendClaim.lean:92](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L92) — The oracle verifier for `SendClaim` is a **pure pass-through**: it returns the statement and exposes
- `def SendSingleWitness.outputIndexEmbedding` [ArkLib/ProofSystem/Component/SendWitness.lean:341](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L341) — The index embedding that exposes every input oracle and the single witness message as output oracles
...
- `theorem ArkLib.Lattices.Ajtai.InnerOuter.perfectlyCorrect` [ArkLib/Commitments/Functional/Hachi/InnerOuter/Correctness.lean:190](../../../ArkLib/Commitments/Functional/Hachi/InnerOuter/Correctness.lean#L190) — **Unconditional perfect correctness with Hachi's balanced decomposition.** Both message and inner de
...
- `lemma ArkLib.Lattices.Ajtai.InnerOuter.prover_runToRound_last` [ArkLib/Commitments/Functional/Hachi/QuadEval/Completeness.lean:339](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Completeness.lean#L339) — **Honest execution of both rounds.** Running the Figure-3 prover to the last round draws the challen
...
- `lemma ArkLib.Lattices.Ajtai.InnerOuter.prover_run_eq` [ArkLib/Commitments/Functional/Hachi/QuadEval/Completeness.lean:383](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Completeness.lean#L383) — **The honest prover's run in closed form.** `prover_runToRound_last` followed by `output`: the prove
...
- `theorem ReduceClaim.reduction_run_support` [ArkLib/ProofSystem/Component/ReduceClaim.lean:133](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L133) — **The `ReduceClaim` reduction's honest run, in closed form.** A zero-round reduction draws nothing a

### `reduction_verifier_eq_verifier` (2 declarations, 2 files)

- `lemma Sumcheck.Spec.reduction_verifier_eq_verifier` [ArkLib/ProofSystem/Sumcheck/Spec/General.lean:194](../../../ArkLib/ProofSystem/Sumcheck/Spec/General.lean#L194) — (no docstring)
- `lemma Sumcheck.Spec.SingleRound.reduction_verifier_eq_verifier` [ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean:993](../../../ArkLib/ProofSystem/Sumcheck/Spec/SingleRound.lean#L993) — (no docstring)

### `refl` (2 declarations, 2 files)

- `def Interaction.Oracle.SourceEquiv.refl` [ArkLib/Interaction/Oracle/Source.lean:374](../../../ArkLib/Interaction/Oracle/Source.lean#L374) — Identity equivalence.
- `def ProtocolSpec.Equiv.refl` [ArkLib/OracleReduction/Equiv.lean:94](../../../ArkLib/OracleReduction/Equiv.lean#L94) — (no docstring)
...
- `abbrev RingSwitching.SumcheckPhase.roundKnowledgeError` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:181](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L181) — (no docstring)
...
- `def ArkLib.Lattices.Ajtai.InnerOuter.rowSum` [ArkLib/Commitments/Functional/Hachi/RingSwitch/Reduction.lean:448](../../../ArkLib/Commitments/Functional/Hachi/RingSwitch/Reduction.lean#L448) — Mathlib view of `cRowSum`, retained for degree and root-counting proofs.
...
- `theorem Reduction.seqCompose_completeness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/GuardedNary.lean:42](../../../ArkLib/OracleReduction/Composition/Sequential/GuardedNary.lean#L42) — Pure prover outputs and guarded verifiers compose with the sum of the component errors when every co
- `theorem OracleReduction.seqCompose_completeness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/OracleCompleteness.lean:74](../../../ArkLib/OracleReduction/Composition/Sequential/OracleCompleteness.lean#L74) — Pure prover outputs and guarded ordinary verifiers compose with the sum of the component errors when

### `seqCompose_perfectCompleteness_of_guarded_verifiers` (2 declarations, 2 files)

- `theorem Reduction.seqCompose_perfectCompleteness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/GuardedNary.lean:75](../../../ArkLib/OracleReduction/Composition/Sequential/GuardedNary.lean#L75) — Pure prover outputs and guarded verifiers preserve perfect completeness of a finite sequence when ev
- `theorem OracleReduction.seqCompose_perfectCompleteness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/OracleCompleteness.lean:100](../../../ArkLib/OracleReduction/Composition/Sequential/OracleCompleteness.lean#L100) — Pure prover outputs and guarded ordinary verifiers preserve perfect completeness of a finite oracle-
...
- `def sumcheckFoldOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:608](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L608) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.sumcheckFoldOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:253](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L253) — (no docstring)

### `sumcheckFoldOracleReduction_perfectCompleteness` (2 declarations, 2 files)

- `theorem sumcheckFoldOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:661](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L661) — Perfect completeness for the core interaction oracle reduction
- `theorem Binius.FRIBinius.CoreInteractionPhase.sumcheckFoldOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:325](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L325) — (no docstring)

### `sumcheckFoldOracleVerifier` (2 declarations, 2 files)

- `def sumcheckFoldOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:403](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L403) — (no docstring)
- `def Binius.FRIBinius.CoreInteractionPhase.sumcheckFoldOracleVerifier` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:242](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L242) — (no docstring)

### `sumcheckFoldOracleVerifier_rbrKnowledgeSoundness` (2 declarations, 2 files)

- `theorem sumcheckFoldOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:749](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L749) — Round-by-round knowledge soundness for the sumcheck fold oracle verifier
- `theorem Binius.FRIBinius.CoreInteractionPhase.sumcheckFoldOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:449](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L449) — (no docstring)

### `symm` (2 declarations, 2 files)

- `def Interaction.Oracle.SourceEquiv.symm` [ArkLib/Interaction/Oracle/Source.lean:378](../../../ArkLib/Interaction/Oracle/Source.lean#L378) — Reverse an equivalence.
- `def ProtocolSpec.Equiv.symm` [ArkLib/OracleReduction/Equiv.lean:99](../../../ArkLib/OracleReduction/Equiv.lean#L99) — (no docstring)

### `toORelOut` (2 declarations, 2 files)

- `def SendClaim.toORelOut` [ArkLib/ProofSystem/Component/SendClaim.lean:176](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L176) — The output relation of `SendClaim`: the input relation (read off the pass-through oracles at `inl`)
- `def SendSingleWitness.toORelOut` [ArkLib/ProofSystem/Component/SendWitness.lean:429](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L429) — (no docstring)
...
- `theorem CompPoly.CPolynomial.toPoly_injective` [ArkLib/ToCompPoly/Univariate/Basic.lean:348](../../../ArkLib/ToCompPoly/Univariate/Basic.lean#L348) — `toPoly` is injective: it is the forward map of the ring equivalence `CPolynomial.ringEquiv`. This i

### `toPolynomial` (2 declarations, 2 files)

- `def ArkLib.Lattices.Hachi.toPolynomial` [ArkLib/Commitments/Functional/Hachi/EvalSplit.lean:198](../../../ArkLib/Commitments/Functional/Hachi/EvalSplit.lean#L198) — Inverse reshape of `toMatrix`: read the `2 ^ nl × 2 ^ nh` matrix back into the `2 ^ (nl + nh)` coeff
...
- `def ArkLib.Lattices.Ajtai.InnerOuter.unflatten` [ArkLib/Commitments/Functional/Hachi/RingSwitch/Rlin.lean:113](../../../ArkLib/Commitments/Functional/Hachi/RingSwitch/Rlin.lean#L113) — Un-flatten a row-major block vector into blocks — the inverse of `PolyVec.flattenBlocks`.
...
- `def ArkLib.Lattices.Ajtai.InnerOuter.verifierPureForm` [ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean:442](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean#L442) — **The pass-through verifier's purity as data** (`Verifier.PureForm`): the verdict is the pass-throug
...
- `theorem ReduceClaim.verifier_coordinateWiseSpecialSoundWith` [ArkLib/ProofSystem/Component/ReduceClaim.lean:247](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L247) — **Coordinate-wise special soundness of `ReduceClaim`, named form.** The verifier is pure with no cha
- `theorem SendWitness.verifier_coordinateWiseSpecialSoundWith` [ArkLib/ProofSystem/Component/SendWitness.lean:164](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L164) — **Coordinate-wise special soundness of `SendWitness`, named form.** The verifier has no challenge ro
...
## Near-duplicate docstrings (Jaccard ≥ 0.85, 77 cross-file pairs)
...
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:997](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L997) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:394](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L394)
    - a: Perfect completeness for the final sumcheck step
    - b: Perfect completeness for the final sumcheck step
...
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:1024](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L1024) vs `RingSwitching.SumcheckPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:412](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L412)
    - a: The round-by-round extractor for the final sumcheck step
    - b: The round-by-round extractor for the final sumcheck step
...
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:714](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L714) vs `RingSwitching.SumcheckPhase.finalSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:461](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L461)
    - a: The knowledge state function for the final sumcheck step
    - b: The knowledge state function for the final sumcheck step
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:593](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L593) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:379](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L379)
    - a: The oracle reduction for the final sumcheck step
    - b: The oracle reduction for the final sumcheck step
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:610](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L610) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:394](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L394)
    - a: Perfect completeness for the final sumcheck step
    - b: Perfect completeness for the final sumcheck step
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:736](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L736) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:484](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L484)
    - a: Round-by-round knowledge soundness for the final sumcheck step
    - b: Round-by-round knowledge soundness for the final sumcheck step
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:639](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L639) vs `RingSwitching.SumcheckPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean:412](../../../ArkLib/ProofSystem/RingSwitching/Packing/SumcheckPhase.lean#L412)
    - a: The round-by-round extractor for the final sumcheck step
    - b: The round-by-round extractor for the final sumcheck step
...
- **1.00** `Prover.runToRoundFS` [ArkLib/OracleReduction/FiatShamir/Basic.lean:100](../../../ArkLib/OracleReduction/FiatShamir/Basic.lean#L100) vs `Prover.runToRoundDSFS` [ArkLib/OracleReduction/FiatShamir/DuplexSponge/Defs.lean:200](../../../ArkLib/OracleReduction/FiatShamir/DuplexSponge/Defs.lean#L200)
    - a: Run the prover in an interactive reduction up to round index `i`, via first inputting the statement
    - b: Run the prover in an interactive reduction up to round index `i`, via first inputting the statement
- **1.00** `Reduction.append_completeness_of_prover_factorization` [ArkLib/OracleReduction/Composition/Sequential/Append/Completeness.lean:98](../../../ArkLib/OracleReduction/Composition/Sequential/Append/Completeness.lean#L98) vs `Reduction.append_completeness_of_guarded_prover_factorization` [ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean:117](../../../ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean#L117)
...
- **1.00** `coreInteractionOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:786](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L786) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:777](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L777)
...
- **1.00** `coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:806](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L806) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:801](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L801)
...
- **1.00** `coreInteractionOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:770](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L770) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleVerifier` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:757](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L757)
...
- **1.00** `coreInteractionOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:836](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L836) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:840](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L840)
...
- **1.00** `sumcheckFoldOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:661](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L661) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:801](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L801)
    - a: Perfect completeness for the core interaction oracle reduction
    - b: Perfect completeness for the core interaction oracle reduction
...
- **0.94** `Reduction.append_completeness_of_pure_verifiers` [ArkLib/OracleReduction/Composition/Sequential/Append/Completeness.lean:144](../../../ArkLib/OracleReduction/Composition/Sequential/Append/Completeness.lean#L144) vs `Reduction.append_completeness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean:158](../../../ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean#L158)
...
- **0.88** `Reduction.append_perfectCompleteness_of_pure_verifiers` [ArkLib/OracleReduction/Composition/Sequential/Append/Completeness.lean:160](../../../ArkLib/OracleReduction/Composition/Sequential/Append/Completeness.lean#L160) vs `Reduction.append_perfectCompleteness_of_guarded_verifiers` [ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean:174](../../../ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean#L174)
...
- **0.88** `OracleVerifier.knowledgeSoundnessWith` [ArkLib/OracleReduction/Security/Basic.lean:486](../../../ArkLib/OracleReduction/Security/Basic.lean#L486) vs `OracleVerifier.rbrKnowledgeSoundness` [ArkLib/OracleReduction/Security/RoundByRound.lean:735](../../../ArkLib/OracleReduction/Security/RoundByRound.lean#L735)
    - a: Knowledge soundness of an oracle reduction is the same as for non-oracle reductions.
    - b: Round-by-round knowledge soundness of an oracle reduction is the same as for non-oracle reductions.
- **0.88** `Reduction.completeness_of_pure_states` [ArkLib/OracleReduction/Composition/Sequential/Append/Completeness.lean:79](../../../ArkLib/OracleReduction/Composition/Sequential/Append/Completeness.lean#L79) vs `Reduction.completeness_of_guarded_states` [ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean:98](../../../ArkLib/OracleReduction/Composition/Sequential/GuardedCompleteness.lean#L98)
