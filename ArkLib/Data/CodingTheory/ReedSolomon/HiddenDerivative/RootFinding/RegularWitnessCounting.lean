...
def _root_.PolynomialDifferential.BoundedSolution.regularJetAt
    [CommSemiring F] {Q : DifferentialPolynomial F d} {D : ℕ}
...
@[simp]
theorem _root_.PolynomialDifferential.BoundedSolution.regularJetAt_value
    [CommSemiring F]
