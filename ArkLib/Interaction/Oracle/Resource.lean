...
/-- A nonempty allocation cannot be tensored with itself under an independence pretense. -/
...
def toSourceHom (view : ResourceView.{i, s, h} S)
  ...
  SourceHom.fromReindex (S.asSource C) (fun query => ⟨view.resolve query.1, query.2⟩)
